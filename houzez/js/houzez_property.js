...
jQuery(document).ready(function ($) {
  ...
  if (typeof houzezProperty !== "undefined") {
    ...
    $(".property-lead-js").on("change", function () {
    ...
    $(".remove-prop-featured").click(function (e) {
      ...
      bootbox.confirm({
        message:
          "<strong>" + houzezProperty.confirm_featured_remove + "</strong>",
        buttons: {
          confirm: {
            label: confirm_btn_text,
            className: "btn btn-primary",
    ...
    var add_new_property_validation = function () {
      ...
      if (form.length > 0) {
        form.validate({
          ignore:
            ":hidden:not(.submit-form-wrap .account-block.active .selectpicker)",
        ...
        if (response.success) {
          ...
          if (thumbHolder) {
            ...
            var gallery_thumbnail =
              ...
              '" data-attachment-id="' +
              response.attachment_id +
              '"><span class="btn-loader houzez-loader-js"></span><i class="houzez-icon icon-remove-circle"></i></button>' +
              "</div>" +
    ...
    var houzez_property_attachments = function () {
      ...
      atch_uploader.bind("FilesAdded", function (up, files) {
        ...
        document.getElementById("houzez_attachments_container").innerHTML +=
          houzez_thumbs;
        up.refresh();
        atch_uploader.start();
      });
      ...
      atch_uploader.bind("UploadProgress", function (up, file) {
        document.getElementById("attachment-holder-" + file.id).innerHTML =
    ...
    var thread_message_attachment = function () {
      ...
      uploader.bind("FilesAdded", function (up, files) {
        ...
        document.getElementById("property-thumbs-container").innerHTML +=
          propertyThumb;
        up.refresh();
        uploader.start();
      });
