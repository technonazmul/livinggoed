                                        ...
                                        <?php foreach ($listing_images as $prop_image_id => $prop_image_meta) {
                                            ...
                                            <div data-thumb="<?php echo esc_url($thumb[0]); ?>">
                                                <?php if ($gallery_type == 'photoswipe') { ?>
                                                    <a data-elementor-open-lightbox="yes" data-elementor-lightbox-slideshow="all-<?php echo esc_attr($gallery_token); ?>" href="<?php echo esc_url($prop_image_meta['full_url']); ?>">
