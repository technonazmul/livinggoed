                ...
                <div class="property-banner">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane show active" id="pills-gallery" role="tabpanel" aria-labelledby="pills-gallery-tab">
                            ...
                            <a class="property-banner-trigger" data-elementor-open-lightbox="yes" data-elementor-lightbox-slideshow="all-<?php echo esc_attr($gallery_token); ?>" href="<?php echo esc_url($featured_image_url[0]); ?>">
		                    ...
		                    <?php
		                        if( !empty($listing_images) && count($listing_images)) {
